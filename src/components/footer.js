    ...
    <footer className={`footer-footer ${props.rootClassName} `}>
      <footer className="footer-footer1 footerContainer">
        ...
        <div className="footer-container">
          ...
          <Link to="/contact-us" className="footer-navlink">
            {props.text1}
          </Link>
...
Footer.defaultProps = {
  linkIcon1: 'https://instagram.com/',
  linkIcon: 'https://twitter.com',
  text1: 'Contact Us',
  rootClassName: '',
  linkIcon2: 'https://facebook.com/',
  text: '© 2024 I WANT FOOD, All Rights Reserved.',
}
