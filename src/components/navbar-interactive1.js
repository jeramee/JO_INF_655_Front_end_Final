      ...
      >
        ...
        >
          <nav className="navbar-interactive1-links">
            ...
            <Link to="/ingredients-ok" className="navbar-interactive1-navlink1">
              {props.text1}
            </Link>
            <Link to="/recipe-ok" className="navbar-interactive1-navlink2">
              {props.text2}
            </Link>
            <span className="navbar-interactive1-text">{props.text3}</span>
            <Link to="/places-ok" className="navbar-interactive1-navlink3">
              {props.text4}
            </Link>
            <img
              alt={props.pastedImageAlt}
              src={props.pastedImageSrc}
              className="navbar-interactive1-pasted-image"
            />
          </nav>
          <div className="navbar-interactive1-buttons">
            <button className="navbar-interactive1-login button">
              {props.login}
            </button>
        ...
        >
          <div className="navbar-interactive1-nav">
            ...
            <nav className="navbar-interactive1-links1">
              <span className="navbar-interactive1-text1">{props.text5}</span>
              <span className="navbar-interactive1-text2">{props.text6}</span>
              <span className="navbar-interactive1-text3">{props.text7}</span>
              <span className="navbar-interactive1-text4">{props.text8}</span>
              <span className="navbar-interactive1-text5">{props.text9}</span>
            </nav>
            <div className="navbar-interactive1-buttons1">
              <button className="navbar-interactive1-login1 button">
                {props.login1}
              </button>
          ...
          <div>
            <svg
              ...
              className="navbar-interactive1-icon04"
            >
